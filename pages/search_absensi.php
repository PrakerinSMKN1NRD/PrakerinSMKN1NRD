...
<?php
	...
	$key=$_POST['key'];
	$sql=mysql_query("select * from view_absensi where id_dudi='$id_dudi' and nama like '%$key%' order by no_id");
	$rows=mysql_num_rows($sql);
?>

<div style="margin-top: 20px;">
<h3>Pencarian Data Absensi Siswa</h3>
...
Hasil pencarian data absensi siswa dengan keyword <i><b>"<?php echo $key; ?>"</b></i> :
</div>
