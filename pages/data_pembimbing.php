...
?>
	<a href="?page=add_pembimbing" title="Tambah data pembimbing">
	<button type="submit" name="tambah_data" class="button-style" style="margin-left: -3px; margin-right: 3px;">Tambah Data</button>
	</a>
<?php
		}
?>
	<a href="export/exp_pembimbing.php" target="_blank" title="Download Data">
...
?>
	...
	<form action="?page=search_pembimbing" method="post" class="form-wrapper cf" style="margin-right: -2px;">
		<input name="key" id="input" type="text" placeholder="Ketik nama pembimbing..." required="required" />
...
<?php
	$limit=20;
	$query=new CnnNav($limit,'view_pembimbing','*','nama');
