...
?>
	...
	<form action="?page=search_kelas" method="post" class="form-wrapper cf" style="margin-right: -2px;">
		<input name="key" id="input" type="text" placeholder="Ketik nama kelas..." required="required" />
...
<?php
	$limit=20;
	$query=new CnnNav($limit,'view_kelas','*','id_kelas');
...
?>
  ...
  <tr bgcolor="<?php echo $color; ?>">
    ...
    <td align="left"><?php echo $data['nama_kelas']; ?></td>
	<td align="center" valign="middle"><?php echo $data['jml_siswa']; ?></td>
    <td align="left"><?php echo $data['nm_jurusan']; ?></td>
	<td align="center" valign="middle">
	<a href="?page=edit_kelas&id=<?php echo $data['id_kelas']; ?>"><img src="images/edit.png" width="13px" height="auto" title="Edit data" style="margin-right: 5px;" /></a>
	<a href="?page=data_kelas&menu=hapus&id=<?php echo $data['id_kelas']; ?>" <?php hapus(); ?>><img src="images/delete.png" width="13px" height="auto" title="Hapus data" /></a>
	</td>
  </tr>
