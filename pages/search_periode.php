...
<?php
	...
	$key=$_POST['key'];
	$sql=mysql_query("select * from periode where nama_periode like '%$key%' order by id_periode");
	$rows=mysql_num_rows($sql);
?>

<div style="margin-top: 20px;">
<h3>Pencarian Data Periode</h3>
...
Hasil pencarian data periode dengan keyword <i><b>"<?php echo $key; ?>"</b></i> :
</div>
