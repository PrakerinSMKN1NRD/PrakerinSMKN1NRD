...
<?php
	...
	$key=$_POST['key'];
	$sql=mysql_query("select * from jurusan where nm_jurusan like '%$key%' order by id_jurusan");
	$rows=mysql_num_rows($sql);
?>

<div style="margin-top: 20px;">
<h3>Pencarian Data Jurusan</h3>
...
Hasil pencarian data jurusan dengan keyword <i><b>"<?php echo $key; ?>"</b></i> :
</div>
</table>
