...
<?php
	...
	$key=$_POST['key'];
	$sql=mysql_query("select * from jurnal_harian where nis='$nis' and nama_keg like '%$key%' order by no_id");
	$rows=mysql_num_rows($sql);
?>

<div style="margin-top: 20px;">
<h3>Pencarian Data Jurnal Harian</h3>
...
Hasil pencarian data jurnal harian dengan keyword <i><b>"<?php echo $key; ?>"</b></i> :
</div>
