...
?>
	...
	<?php echo $index; ?> &raquo; Bursa Kerja
	</span>
	</div>
<?php
		break;
...
?>
	<div align="left" style="border-bottom: 1px solid #ccc; padding: 0 5px 5px 5px;">
	<span style="font-size: 12px;">
	<?php echo $index; ?> &raquo; Pengembang
	</span>
	</div>
<?php
		break;
...
?>
	<div align="left" style="border-bottom: 1px solid #ccc; padding: 0 5px 5px 5px;">
	<span style="font-size: 12px;">
	<?php echo $index; ?> &raquo; Hubungi Kami
	</span>
	</div>
<?php
		break;
...
?>
	<div align="left" style="border-bottom: 1px solid #ccc; padding: 0 5px 5px 5px;">
	<span style="font-size: 12px;">
	<?php echo $index; ?> &raquo; Profil SMKN 1 Narmada
	</span>
	</div>
<?php
		break;
...
?>
	<div align="left" style="border-bottom: 1px solid #ccc; padding: 0 5px 5px 5px;">
	<span style="font-size: 12px;">
	<?php echo $index; ?> &raquo; Teknik Komputer dan Jaringan
	</span>
	</div>
<?php
		break;
...
?>
	<div align="left" style="border-bottom: 1px solid #ccc; padding: 0 5px 5px 5px;">
	<span style="font-size: 12px;">
	<?php echo $index; ?> &raquo; Teknik Sepeda Motor
	</span>
	</div>
<?php
		break;
...
?>
	<div align="left" style="border-bottom: 1px solid #ccc; padding: 0 5px 5px 5px;">
	<span style="font-size: 12px;">
	<?php echo $index; ?> &raquo; Multimedia
	</span>
	</div>
<?php
		break;
