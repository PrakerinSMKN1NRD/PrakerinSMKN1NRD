<form name="setting_profil_siswa" method="post">
  <table width="100%" align="center" cellpadding="3" cellspacing="3">
    <tr>
      <td width="21%">NIS<sup><span style="color: red;"> * </span></sup></td>
      <td width="3%" align="center">:</td>
      <td width="76%"><span id="sprytextfield1">
        <input name="nis" type="text" id="nis" value="<?php echo $data['nis']?>" maxlength="15" style="width: 99px;" disabled="disabled" />
    ...
    <tr>
      ...
      <td>
		...
		<a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.setting_profil_siswa.tgl_lahir); return false;">
