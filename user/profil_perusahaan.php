...
<table width="100%" cellpadding="3">
  <tr>
    <td width="37%" rowspan="5" align="center" valign="top"><img alt="<?php echo $foto; ?>" title="<?php echo $data['nama_dudi']; ?>" src="images/user/<?php echo $foto; ?>" width="99%" height="auto" style="border: 1px solid #ccc;"></td>
